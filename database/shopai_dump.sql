-- ============================================================
-- ShopAI — Dump complet (schéma + données de démonstration)
-- Généré et VÉRIFIÉ sur MySQL.
-- Import : mysql -u root -p < shopai_dump.sql
--
-- Comptes : admin@shopai.ma / Admin123!
--           client@shopai.ma · sara@ · omar@ · fatima@ · mehdi@shopai.ma / Client123!
-- Contenu : 24 produits · 5 catégories · 12 commandes · 8 logs
-- ============================================================
...
--
-- Current Database: `shopai`
--

/*!40000 DROP DATABASE IF EXISTS `shopai`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `shopai` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
INSERT INTO `ActivityLogs` VALUES
('191e4148-8a29-44db-8fbc-b2711a0f918f',NULL,'LOGIN_FAILED','196.75.16.26','Mozilla/5.0 (Windows NT 10.0; Win64; x64)','Tentative échouée pour admin@shopai.ma','2026-07-10 10:00:00'),
...
('2b3c607f-74f8-4cbe-8ec3-d4e09793d226','3942b189-d884-4337-bf69-a7ed72886c78','8 Rue de la Liberté','Marrakech','40000','Maroc','2026-07-29 02:29:58','2026-07-29 02:29:58'),
...
('7ceb82dd-7fbf-4328-8c80-6da65ccf6637','Maison Connectée','maison-connectee','Catégorie Maison Connectée',NULL,'2026-07-29 02:29:58','2026-07-29 02:29:58'),
...
('02b10993-7866-49b5-8751-9453e6f73fc2','ecee1b27-df9c-4fb5-8f8d-049c52613161','edb1796b-6fc0-438a-bd31-0dbe11999132',2,24.99,'2026-03-06 10:00:00','2026-03-06 10:00:00'),
...
CREATE TABLE `Orders` (
  ...
  CONSTRAINT `Orders_ibfk_2` FOREIGN KEY (`addressId`) REFERENCES `Addresses` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('10ee65c8-c6ee-43a5-babe-3822cf8477a8','244ffbf3-42f9-4bda-8186-a930aceb37f7','cancelled',249.97,'6bd6e821-5455-4c78-b165-046efda8f765','2026-07-16 10:00:00','2026-07-16 10:00:00'),
...
('0cf2c418-802a-4e55-9670-6bc15b2b9a01','mehdi@shopai.ma','$2a$10$SNt1p7gTzDpgEq5oS4YTU.lNmme7t7AdQdlJH3NPgtO47fZSgmx0W','Mehdi','Alaoui','client',1,0,NULL,'2026-07-29 02:29:58','2026-07-29 02:29:58'),
